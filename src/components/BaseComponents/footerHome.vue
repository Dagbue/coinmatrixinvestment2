...
<!--              </div>-->
      ...
      <div class="section-part">
        ...
        <a href="">
          <img src="@/assets/logo_cryptovalley.svg" class="footer-partner" />
        </a>

        <a href="">
          <img src="@/assets/Visa.svg" class="footer-partner-2"  />
        </a>

        <a href="">
          <img src="@/assets/SkrillLogo.svg" class="footer-partner-2"  />
        </a>
