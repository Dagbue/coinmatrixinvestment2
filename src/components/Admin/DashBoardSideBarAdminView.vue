  ...
  <div class="outer">
    ...
    <div class="sidebar" v-show="!mobile">
      ...
      <ul class="nav-list" >
        ...
        <router-link to="/admin-list-of-users">
          <li>
            <a class="hover">
        ...
        <router-link to="/admin-deposit-requests">
          <li>
            <a class="hover">
        ...
        <router-link to="/admin-withdrawal-requests">
          <li>
            <a class="hover">
        ...
        <router-link to="/admin-trade-request-admin">
          <li>
            <a class="hover">
              <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />
        ...
        <router-link to="/admin-add-trade">
          <li>
            <a class="hover">
              <img src="@/assets/send.svg" alt="logo" class="link-img" />
        ...
        <router-link to="/admin-uploaded-ID">
          <li>
            <a class="hover">
        ...
        <router-link to="/admin-change-password-admin">
          <li>
            <a class="hover">
              <img src="../../assets/settings.svg" alt="logo" class="link-img" />
        ...
        <router-link to="/admin-add-new-user">
          <li>
            <a class="hover">
              <img src="@/assets/dashboardlogo.svg" alt="logo" class="link-img" />
    ...
    <div  class="dropdown-nav-2" v-show="mobileNav" >
      ...
      <ul>
        <li @click="toggleMobileNav2">
          <a>
            <img src="@/assets/dashboardlogo.svg" alt="logo" class="link-img" />
            <router-link to="/admin-list-of-users" class="">List Of Users</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/walletmana.svg" alt="logo" class="link-img" />
            <router-link  to="/admin-deposit-requests" class="">Deposit Request</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <i class='bx bx-support' ></i>
            <router-link to="/admin-withdrawal-requests" class="">Withdrawal Request</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />
            <router-link to="/admin-trade-request-admin" class="">Trade Request</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/coin-stack.svg" alt="logo" class="link-img" />
            <router-link to="/admin-add-trade" class="">Add Trade</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="@/assets/pie-chart.svg" alt="logo" class="link-img" />
            <router-link to="/admin-payment-details" class="">Payment Details</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/virtacc.svg" alt="logo" class="link-img" />
            <router-link to="/admin-uploaded-ID" class="">Uploaded ID's</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/virtacc.svg" alt="logo" class="link-img" />
            <router-link to="/admin-change-password-admin" class="">Change Password</router-link>
          </a>
        </li>
        <li @click="toggleMobileNav2">
          <a>
            <img src="../../assets/virtacc.svg" alt="logo" class="link-img" />
            <router-link to="/admin-add-new-user" class="">Add New User</router-link>
          </a>
        </li>
